<?php
    ...
    if(isset($_SESSION["id"])){?>
        <?php
       require_once("otros/navAdmin.php");
        ?>
        <div class="container">
            <div class="page-header">
              <h1 class="all-tittles">Consultas<small>.</small></h1>
            </div>
        </div>
        ...
        <section class="full-reset text-center" style="padding: 40px 0;">
            ...
            <article class="tile">
                <a href="consultaAnalisisAdmin.php">
                <div class="tile-icon full-reset"><i class="zmdi zmdi-nature"></i></div>
                <div class="tile-name all-tittles">Analisis de suelos</div>
                <div class="tile-num full-reset">2</div>
                </a>
            </article>
            <article class="tile">
                <a href="consultaFertilizantesAdmin.php">
