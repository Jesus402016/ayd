<?php
    ...
    if(isset($_SESSION["id"])){?>
        ...
        <section class="full-reset text-center" style="padding: 40px 0;">
            ...
            <article class="tile" data-toggle="modal" data-target="#modalRegistroUsuario" type="submit">
                <div class="tile-icon full-reset"><i class="zmdi zmdi-pin-drop"></i></div>
                <div class="tile-name all-tittles">Registrar Usuario</div>
        ...
        <div class="col-md-8 col-md-offset-2">
            <table id="ejemploUsuario" class="table table-striped table-bordered" cellspacing="0" width="100%">
                <thead>
                <tr>
                    <th>nombre</th>
                    <th>cedula</th>
        ...
        <div class="modal fade" tabindex="-1" role="dialog" id="ModalHelp">
          ...
          <!-- modal RegistrarUsuario-->
     <div class="modal fade" id="modalRegistroUsuario" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
      <div class="modal-dialog" role="document">
    <div class="modal-content">
      <script>setTimeout ("idFinca('<?php echo $_SESSION['id']?>')", 5);</script>
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
